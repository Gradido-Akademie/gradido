...
const seesAllCreationGroups = computed(() => store.state.moderator?.seesAllCreationGroups ?? true)
const visibleCreationGroups = computed(() => store.state.moderator?.visibleCreationGroups ?? [])
...
const creationGroupOption = (creationGroupItem) => ({
  value: creationGroupItem.tag,
  text: creationGroupItem.name
    ? `${creationGroupItem.name} (#${creationGroupItem.tag})`
    : `#${creationGroupItem.tag}`,
})
