...
describe('clearStoragePreservingPreferences', () => {
  beforeEach(() => {
    vi.stubGlobal(
      ...
      createLocalStorageMock({
        ...
        'crea.moderatorSignature': 'Liebe Gruesse, Bernd',
  ...
  it('keeps the crea moderator signature', () => {
    clearStoragePreservingPreferences()
    expect(localStorage.getItem('crea.moderatorSignature')).toBe('Liebe Gruesse, Bernd')
  })
  ...
  it('does not resurrect a preference that was not stored', () => {
    localStorage.removeItem('crea.moderatorSignature')
    clearStoragePreservingPreferences()
    expect(localStorage.getItem('crea.moderatorSignature')).toBeNull()
  })
})
