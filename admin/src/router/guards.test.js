...
describe('Navigation Guards', () => {
  ...
  // The guard above lets anyone with any role through, so hiding a menu entry would not keep
  // a moderator out — they could still type the URL. This is where that way in is closed.
