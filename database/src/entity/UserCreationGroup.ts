...
// Group functions (Gruppen-Funktionen, "Weg A"): a user's personal creation-group list.
...
// No FK constraints (matches the gms_entries / crea_records convention) — indices only.
