...
// Group functions ("Weg A"): what to pre-select in the group field when someone submits.
//
...
//
// The middle case is what the group_tags_set_at stamp (migration 0111) is for: a
