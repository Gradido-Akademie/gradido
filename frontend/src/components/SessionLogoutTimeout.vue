...
// The modal normally warns 75 s before the session (JWT) expires.
// TEST SCAFFOLD - revert to 75 before opening the PR: 570 makes the modal appear
// about 30 s after login on the 10-minute staging token, so the flow (extend /
// logout / buttons) can be checked without waiting ~9 minutes.
const MODAL_WARNING_SECONDS = 570 // TODO: revert to 75 before PR
